...
public final class Edit_005fCenter_jsp extends org.apache.jasper.runtime.HttpJspBase
	...
	String code=null;
	int id=0;
	String c_name="",c_latitude="",c_longitude="";
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	if(rs != null)
	{
		if(rs.next())
		{
			...
			c_latitude = rs.getString(3);
			c_longitude = rs.getString(4);
      ...
      out.print(request.getContextPath());
      out.write("/CreateCenteroid\" method=\"get\">\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t<h1>Update Center Details</h1>\r\n");
      ...
      out.write("\t\t\t        ");
      out.write("\r\n");
      out.write("\t\t\t\t\t<input type=\"text\" id=\"x\" name=\"c_latitude\" value=\"");
      out.print(c_latitude);
      out.write("\" placeholder=\"Enter The Latitude(x-asis)\" class=\"easyui-validatebox\"   required=\"required\" title=\"Math The Format : -90.XXXXXX to 90.XXXXXX\"/>\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t\r\n");
      ...
      out.write("\t\t\t        ");
      out.write("\r\n");
      out.write("\t\t\t\t\t<input type=\"text\" id=\"y\" name=\"c_longitude\" value=\"");
      out.print(c_longitude);
      out.write("\" placeholder=\"Enter The Longitude(y-axis)\" class=\"easyui-validatebox\" required=\"required\"    title=\"Match The Formate : -180.XXXXXX to 180.XXXXXX\"/>\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t\r\n");
	...
	if(Utility.parse(request.getParameter("no"))==1)
	{
      ...
      out.write("\t\t\t<p>Center Details Updated Successfully......</p>\r\n");
      out.write("\t\t</div>\t\t\t\r\n");
	...
	if(Utility.parse(request.getParameter("no"))==3)
	{
      ...
      out.write("\r\n");
      out.write("\t\t<div class=\"error\" id=\"message\" style=\"position:absolute;top:421px;left:11px\">\t\r\n");
      out.write("\t\t\t<p>Sorry,This Center is already exist!!!!!</p>\r\n");
      out.write("\t\t</div>\t\t\t\r\n");
